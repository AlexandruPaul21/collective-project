    ...
    const handleFavoriteClick = async () => {
        ...
        try {
            if (isFavoriteNGO) {
                ...
                await removeNgoFromFavorites(currentUser.username, currentUser.password, favoriteNgoData);
                setIsFavoriteNGO(false);
                console.log("Removed from favorites" + favoriteNgoData);
            } else {
                // If it's not a favorite, add it
                await addNgoToFavorites(currentUser.username, currentUser.password, favoriteNgoData);
